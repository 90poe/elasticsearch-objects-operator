...
const (
	...
	ConditionReasonCreateIndex    = "CreateIndex"
	ConditionReasonUpdateIndex    = "UpdateIndex"
	ConditionReasonCreateTemplate = "CreateTemplate"
	ConditionReasonUpdateTemplate = "UpdateTemplate"
