...
define build_target
	...
	-mod=vendor \
	-ldflags="-s -w \
	-X github.com/90poe/elasticsearch-objects-operator/internal/version.Version=$(VERSION) \
	-X github.com/90poe/elasticsearch-objects-operator/internal/version.BuildDate='$(BUILT_AT)' \
	-X github.com/90poe/elasticsearch-objects-operator/internal/version.GitHash=$(GIT_COMMIT)" \
	-o bin/manager-$(1)-$(2) \
	cmd/main.go ;
endef
